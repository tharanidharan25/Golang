...
func main() {
	...
	*/
	...
	// Now we can redo this example of a set by using a more efficient map with empty structs, which don't take up any space in memory:
	newAttended := map[string]struct{}{
		"Ann": {},
		"Joe": {},
	}

	if _, ok := newAttended["Ann"]; ok {
		fmt.Println("Ann", "was at the meeting")
	}
